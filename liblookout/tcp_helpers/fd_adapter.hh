#ifndef LXLOOKOUTRECORD_LIBLOOKOUT_FD_ADAPTER_HH
#define LXLOOKOUTRECORD_LIBLOOKOUT_FD_ADAPTER_HH
...
//! \details See TCPOverUDPSocketAdapter and TCPOverIPv4OverTunFdAdapter for information.
class FdAdapterBase {
  private:
